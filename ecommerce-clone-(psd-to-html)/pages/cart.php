                                    ...
                                    <tr class="cart-table-row">
                                        <div class="cartRow">
                                            ...
                                            <td data-label="Price" class="tdp">
                                                <p class="priceCart"><?php echo $value['Item_Price'] ?></p>
                                            </td>
                                            <td>
                                                <div class="cartQuantity">
                                                    <a onclick="decrementer()">-</a>
                                                    <input class="incrementer" onchange="inputValue()" type="text" id="quantityInc" name="quantity" value="<?php echo $value['Item_Quantity'] ?>" />
                                                    <a onclick="incrementer()">+</a>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="totalPriceCart"><?php echo $value['Item_Price'] ?> Rs</p>
                                            </td>
                                            <td class="tdp">
